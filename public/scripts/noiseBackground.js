// Public copy of noiseBackground for direct browser module loading
// Kept behavior identical to src/scripts/noiseBackground.js but self-initializes
...
// Auto-initialize when this public module is loaded
try {
    if (typeof document !== 'undefined') {
        initNoiseBackground();
    }
} catch (e) {
    // swallow errors to avoid breaking other inline scripts
    console.error('Noise background init failed:', e);
}
